...
object FakeDeviceCache {
    ...
    val fakeSelinuxContext: String = "u:r:untrusted_app:s0:c512,c768"
    val fakeKernelCmdline: String =
        "androidboot.hardware=qcom androidboot.serialno=${fakeSerial} " +
        "androidboot.boot_devices=soc/1d84000.ufshc printk.devkmsg=on " +
