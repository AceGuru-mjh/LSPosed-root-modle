 ...
 *  - SystemPropSpoofHook: Shizuku setprop 修改 ro.* 系统属??
 *  - GlobalPermissionHook: Shizuku pm revoke 全局权限回收
 *  - NetworkIdentifierHook: Shizuku ip link / ??/sys/class/net 修改网卡 MAC
...
data class PrivacyConfig(
    ...
    var installStatusSpoofEnabled: Boolean = false,   // 应用安装状态伪??
    ...
    /** /proc 文件读取隐藏（拦??su/magisk/xposed 字符串，Hook FileInputStream/BufferedReader/File.exists??*/
    ...
    var sensorNoiseMode: Int = 2,          // 0=静??其他=加噪
