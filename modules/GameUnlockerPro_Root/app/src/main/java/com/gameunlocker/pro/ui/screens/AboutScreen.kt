    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text("�?[系统级] Shizuku setprop 系统属性修�?, style = MaterialTheme.typography.bodySmall)
                ...
                Text("�?[实验] CPU 大核亲和性（�?sysfs�?, style = MaterialTheme.typography.bodySmall)
            }
        }
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(16.dp)) {
                Text("系统级能力说�?, style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.error)
                ...
                Text(
                    ...
                    "5. �?/sys/devices/system/cpu/cpuN/cpufreq 节点设置 CPU governor\n" +
                    "6. am force-stop 冻结非必要后台进�?,
