...
import com.notifymaster.pro.services.FloatingBallService
...
fun HomeScreen(
    ...
    val filteredCount = remember { mutableStateOf(0L) }
    val channelsCount = remember { mutableStateOf(0L) }
    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.fillMaxWidth().padding(24.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Text(
                    "已处理: ${filteredCount.value + channelsCount.value} 次",
        ...
        Card(modifier = Modifier.fillMaxWidth().padding(bottom = 16.dp)) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("已过滤通知", filteredCount.value.toString(), modifier = Modifier.weight(1f))
                    StatBox("已管理通道", channelsCount.value.toString(), modifier = Modifier.weight(1f))
                }
            }
        }
