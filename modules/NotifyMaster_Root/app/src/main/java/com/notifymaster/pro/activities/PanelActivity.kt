package com.notifymaster.pro.activities
...
import com.notifymaster.pro.utils.LogEntry
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("📊 NotifyMaster Pro 控制面板", style = MaterialTheme.typography.titleLarge, modifier = Modifier.weight(1f))
