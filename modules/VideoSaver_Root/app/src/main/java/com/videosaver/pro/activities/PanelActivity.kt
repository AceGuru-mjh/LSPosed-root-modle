package com.videosaver.pro.activities
...
import com.videosaver.pro.utils.LogEntry
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("📊 VideoSaver Pro 控制面板", style = MaterialTheme.typography.titleLarge, modifier = Modifier.weight(1f))
