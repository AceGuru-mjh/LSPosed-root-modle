 ...
 *     - �?/sys/class/sensors/step_counter/value（系统级步数节点�?
 *     - am broadcast 广播步数更新
 *     - �?/proc/step_counter 内核节点
 *     - settings put 修改系统设置
 *
 * 硬性限制：
 *  - 系统�?Hook 必须先检�?isShizukuAvailable()
 *  - �?/sys /proc 需�?root 级别 Shizuku 授权（adb 级可能权限不足）
...
object ShizukuHelper {
     ...
     * 用于�?/sys/class/sensors/step_counter/value�?proc/... �?
     */
