package com.stepmod.pro.activities
...
import com.stepmod.pro.utils.LogEntry
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("📊 StepModifier Pro 控制面板", style = MaterialTheme.typography.titleLarge, modifier = Modifier.weight(1f))
