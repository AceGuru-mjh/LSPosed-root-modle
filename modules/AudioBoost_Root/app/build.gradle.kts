...
android {
    namespace = "com.audioboost.pro"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.audioboost.pro"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.12"
...
dependencies {
    // Xposed API (compileOnly: �?LSPosed 框架运行时提供，避免类冲�?
    compileOnly("de.robv.android.xposed:api:82")

    // Shizuku API (compileOnly, Root 版通过 Shizuku 调用系统级音量命�?
