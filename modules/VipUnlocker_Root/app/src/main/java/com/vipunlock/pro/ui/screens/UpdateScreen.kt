...
import com.vipunlock.pro.utils.ApkDownloader
import com.vipunlock.pro.utils.UpdateChecker
    ...
    Column(
        ...
        info?.let { ui ->
            ...
            if (ui.hasUpdate && !ui.isIgnored) {
                Spacer(Modifier.height(12.dp))
                val apk = UpdateChecker.findMatchingApk(ui, "VipUnlocker_Root")
                if (apk != null) {
        ...
        Card(modifier = Modifier.fillMaxWidth(),
            ...
            Column(modifier = Modifier.padding(12.dp)) {
                ...
                Text("�?模块更新后需�?LSPosed 重新启用并重启目�?APP", style = MaterialTheme.typography.bodySmall)
