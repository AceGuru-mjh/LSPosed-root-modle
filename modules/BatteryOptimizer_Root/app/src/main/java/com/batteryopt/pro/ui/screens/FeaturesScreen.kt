...
fun FeaturesScreen(cfg: BatteryConfig, onConfigChange: (BatteryConfig) -> Unit) {
    ...
    Column(
        ...
        FeatureCard("蓝牙扫描降频", "Hook BluetoothLeScanner.startScan，最??60s",
        ...
        FeatureCard("振动器限??, "Hook Vibrator.vibrate，最小触发间??1s",
        ...
        FeatureCard("后台 APP 冻结", "am force-stop 黑名单，屏幕关闭 N 分钟后批量冻??,
            cfg.freezeEnabled,
        ...
        FeatureCard("孤儿 WakeLock 清理", "dumpsys power 文本分析，识别孤??wake lock",
            cfg.greenifyEnabled,
        ...
        FeatureCard("低电量模式自动切??, "settings put global low_power，电量低于阈值自动开??,
        ...
        FeatureCard("电量统计重置", "dumpsys batterystats --reset，充??N 秒后重置",
        ...
        FeatureCard("内核唤醒优化", "充电时屏幕常??stay_on_while_plugged_in + wake_lock 管理",
